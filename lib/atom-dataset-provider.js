...
app.get('/', function(req, res) {
    ...
    var tenminutesago = (d = new Date()).getTime() + d.getTimezoneOffset() * 60000 - 10 * 60 * 1000;
    
    _.defaults(scanOptions, { groupPattern: options.groupPattern, excludePattern: options.excludePattern,
        entryTitlePattern: options.entryTitlePattern, limit: 40, hashes: options.hashes, before: tenminutesago });
